...
tldr: "Constrain SSL features onto a product of simplices (SEM) to induce structured sparsity and better downstream generalization by **+4-5% accuracy** in downstream image classification tasks."
links:
