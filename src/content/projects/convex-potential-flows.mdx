...
keywords:
  ...
  - optimal transport
  - generative modeling
tldr: "OT‑inspired normalizing flow parameterized via a convex potential. Universal density modeling using input-convex neural networks due to Brenier's theorem with tractable training by estimating gradient of log det Hessian with Hutchinson's estimator."
